...
export default function LandingPage() {
  ...
  return (
    <div className="w-full overflow-x-hidden bg-gradient-to-br from-[#2a0845] via-[#6441a5] to-[#e0437e] text-white relative">
      <div className="absolute top-[-100px] left-[-100px] w-[400px] h-[400px] bg-pink-500 opacity-30 rounded-full blur-3xl animate-pulse z-0" />
    ...
    flex items-center justify-between text-sm text-white font-medium"
      >
        <a
          href="#"
          className="text-lg sm:text-2xl flex font-extrabold bg-gradient-to-r from-white via-pink-300 to-purple-300 bg-clip-text text-transparent drop-shadow-sm"
        >
          <img src="/logo22.png" className="w-[40px] h-[35px] mr-2" />
      ...
      <section className="w-full min-h-screen flex flex-col justify-center items-center px-6 md:px-20 pt-40 pb-24 text-center">
        <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-pink-400 to-purple-400 drop-shadow-lg leading-tight">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-screen-xl w-full">
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="w-full aspect-video bg-gradient-to-br from-purple-500 via-pink-400 to-yellow-300 rounded-lg mb-4 animate-gradient-x" />
      ...
      >
        ...
        <div className="flex flex-col gap-8 max-w-xl w-full z-10">
          ...
          hover:shadow-[0_0_40px_rgba(255,255,255,0.2)] transition-all duration-300"
            >
              <h3 className="text-2xl font-bold mb-2 bg-gradient-to-r from-pink-300 to-purple-300 bg-clip-text text-transparent ">
                {title}
              </h3>
